...
import { LightningFont, LightningFontTheme } from './LightningFont';
...
export default {
  title: 'Design Tokens/Fonts/LightningFont',
  component: LightningFont,
} as Document;

export const overview: Example<ColorProps> = ({ name, color }) => (
  <LightningFont columns={lightningColumns} name={name} color={color} />
);

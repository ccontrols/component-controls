...
Retruns a controls and a setter function from the current controls context, given a control name. This hook is to be used when creating custom control editors.

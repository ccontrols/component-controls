---
title: Structure/Configuration types
route: /tutorial/structure/configuration
type: tutorial
tags:
  - documentation
order: 5
...
Confgurable page type that can be assigned to a document. By default, all documentas are treated as **story** page types.
...
An object of the routes only portion of the page type configuation. The routes configurations are used during build-time to construct the static pages routes.
...
| `navSidebar`  | boolean                                 | whether to add navigation sidebar to navigate all the pages of the same page type |

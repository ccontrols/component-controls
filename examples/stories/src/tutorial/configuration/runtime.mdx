...
| `decorators`      | [StoryRenderFn]((/tutorial/structure/configuration/#storyrenderfn)\[]                                                      | story decorator functions - used to wrap stories example: \[story => &lt;ThemeProvider>{story()}&lt;/ThemeProvider>]                                                                 |
| `pages`           | [PagesConfiguration]((/tutorial/structure/configuration#pagesconfiguration)                                                | page types configurations                                                                                                                                                            |
...
| `toolbar`         | [ToolbarConfig](/tutorial/structure/configuration#toolbarconfig)                                                           | custom toolbar items                                                                                              
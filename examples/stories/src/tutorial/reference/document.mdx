...
<img
  alt="assign document description"
...
Category for the document, for example used by the [addon-catalog](https://github.com/ccontrols/component-controls/tree/master/plugins/addon-catalog) to display components by category ie 'Display', 'Input' etc.
...
<img
  alt="document navigation sidebar"
  title="document navSidebar"
  src={sidebarImg}
/>
...
<img
  alt="document context sidebar"
  title="document context sidebar"
  src={contextImg}
/>
...
<img
  alt="document subcomponents"
  title="document subcomponents"
  src={subcomponentsImg}
/>
...
<img
  alt="document decorators"
  title="document decorators"
  src={decoratorsImg}
/>

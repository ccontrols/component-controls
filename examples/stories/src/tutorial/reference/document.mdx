...
### layout.contextSidebar

type: `boolean`
  
Whether to add a conext sidebar to access the sections on the current page. The default value is from the document type configuration  but can also be changed at the document level.

[MDX](/tutorial/mdx-documentation)
```
---
title: Library/Components/Spinner
layout: { contextSidebar: false }
---
```

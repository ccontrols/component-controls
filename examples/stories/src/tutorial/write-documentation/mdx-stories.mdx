...
You can create interactive components examples (aka stories) similar to [ESM](/tutorial/esmodules-stories/) in [MDX](/tutorial/mdx-documentation/)
...
[ComponentSource](/api/blocks/componentsource/)

---
title: Getting started/Documentation stite
type: tutorial
order: 0
...
Create a new folder called `.config` (or any other name that you used in the SSG setuo above) inside your project's home directory:

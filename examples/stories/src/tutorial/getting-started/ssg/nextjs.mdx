...
Below, we go over how to add a `component-controls` documentation site to both [new](#new-project) and [existing](#existing-nextjs-project) Gatsby projects.
...
Add nextjs and its dependencies:
...
...
  "scripts": {
    ...
    "start-next-server": "next build && next start -p 9031"
  },
...
```
...
Check our [Create documentation site](/tutorial/getting-started/documentation-site) tutorial
...
- the component package name and version
- preview of the first story in the components' document [ESM](https://component-controls.com/tutorial/esmodules-stories) or [MDX](https://component-controls.com/tutorial/esmodules-stories) file.
- the dates the component file was created and last committed
- the number of commits as well
- the component contributors
- the number of commits in the component history
- file stats such as the number of lines and comments

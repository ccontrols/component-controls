...
| storybook   |  [https://storybook.component-controls.com](https://storybook.component-controls.com/?path=/page/introduction-starter--overview) |
...
- **bundle sizes** gatsby shines here, and while it is expected that storybook creates 3 times larger bundles than gatsby since it generates one bundle for al pages, it is strange that the bundles from nextjs are twice as large as the gatsby bundles.

...
> The sample project was bootstrapped from [tw-sb-rtl-starter](https://github.com/ssengalanto/tw-sb-rtl-starter)
...
We can safely remove `@storybook/addon-essentials` from the `main.js` configuration file - this will take out the `Docs` tab from the user interface
...
In this step we will add the `react` webpack configration preset to component-controls

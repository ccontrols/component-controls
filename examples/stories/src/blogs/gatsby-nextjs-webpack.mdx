...
> it nust be noted that most tests will give different results each time they are taken.
...
> gatsby 3 vastly improves on build times over gatsby 2 - the gatsby builds for this app of over 1400 pages came down from over 14 minutes down to just over 3 minutes.
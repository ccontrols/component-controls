...
component-controls provides migration compatibility for many of the documentation features in `docz`. And component-control can also use [gatsby](/tutorial/getting-started/gatsby) as a static site generator.

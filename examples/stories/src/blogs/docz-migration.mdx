...
The **title** field is mapped to the **siteTitle** configuration field.

## description

The **description** field is mapped to the **siteDescription** configuration field.

## menu

The **menu** field is used in component-controls in a similar way to docz. You will need to fill the menu field in a document to attach it to a menu item.

...
<Flex sx={{ flexDirection: 'column', alignItems: 'center', py: 5}}>
  <Flex sx={{ flexDirection: 'row', alignItems: 'center',  flexWrap: 'wrap', justifyContent: 'space-between', maxWidth: '1000px', width: '100%'}}>
    <BoxItem>
      ...
      <Button as={Link} href='/tutorial/getting-started/gatsby'>get started...</Button>
    </BoxItem>
    <BoxItem>
      <Subtitle>Start with Vercel</Subtitle>
      <Button as={Link} href='/tutorial/getting-started/nextjs'>get started...</Button>
    </BoxItem>
    <BoxItem>
      <Subtitle>Start with Storybook</Subtitle>
      <Button as={Link} href='/tutorial/getting-started/storybook'>get started...</Button>
    </BoxItem>
  </Flex>
</Flex>  

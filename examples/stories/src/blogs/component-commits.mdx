...
1. The comment coverage for that file (calculated as **# comment lines / # code lines**)
1. The number of "TODOs" in the file, if any

While the number of source-lines and comment coverage are nice to know, having the number of TODOs

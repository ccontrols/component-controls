...
describe('mdx-playground', () => {
  ...
  createTest('source-prop.mdx', parsed => {
    expect(parsed).toMatchObject({
      transformed:
        '\nimport React from \'react\';\nimport { mdx } from \'@mdx-js/react\';\n\n/* @jsxRuntime classic */\n\n/* @jsx mdx */\nimport { Playground } from \'@component-controls/blocks\';\nimport Button from \'../components/BaseButton\';\nconst layoutProps = {};\nconst MDXLayout = "wrapper";\n\nfunction MDXContent({\n  components,\n  ...props\n}) {\n  return <MDXLayout {...layoutProps} {...props} components={components}>\n\n    <Playground source={`<Button />`}>\n  <Button />\n    </Playground>\n    </MDXLayout>;\n}\n\n;\nMDXContent.isMDXComponent = true;\n\n        const mdxDefaultExport = MDXContent;\n        Object.assign(mdxDefaultExport, \n        {\n        "MDXPage": MDXContent,"isMDXComponent": true,"title": "MDX","componentsLookup": \n        {\n        \n        }\n        ,"package": "e30e55c1bece516a8279bc5ed610d341","dateModified": "2020-12-30T06:22:19.026Z","date": "2020-12-30T06:22:19.025Z"\n        }\n        );\n        export default mdxDefaultExport;\n',
      doc: {
        title: 'MDX',
      },
      exports: {

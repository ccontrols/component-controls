...
| `getFirstDocument*`     | **function** getFirstDocument(`type`\*: [DocumentType](#documenttype)): string \| undefined;                                                |                                                                                                                       |
| `getNextPage*`          | **function** getNextPage(`type`\*: [DocumentType](#documenttype) \| undefined, `docId`\*: string): [Document](#document) \| undefined;      | returns the next page of the same type.                                                                               |
| `getPageList*`          | **function** getPageList(`type`\*: [DocumentType](#documenttype)): [Pages](#pages);                                                         | returns all the documents/pages of a certain type.                                                                    |
| `getPagePath*`          | **function** getPagePath(`type`\*: [DocumentType](#documenttype) \| undefined, `name`\*: string, `activeTab`: string): string;              | returns the url path to a document.                                                                                   |
...
| `getPrevPage*`          | **function** getPrevPage(`type`\*: [DocumentType](#documenttype) \| undefined, `docId`\*: string): [Document](#document) \| undefined;      | returns the previous page of the same type.                                                                           |
